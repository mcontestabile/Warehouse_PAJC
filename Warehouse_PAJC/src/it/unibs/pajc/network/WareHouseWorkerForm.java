...
public class WareHouseWorkerForm extends JFrame {
	...
	private WareHouseWokerView wareHouseWorkerView;
	...
	private void initialize() throws UnknownHostException, IOException, ClassNotFoundException {
		...
		wareHouseWorkerView = new WareHouseWokerView(contentPane, socket);
		...
		contentPane.add(wareHouseWorkerView, UsefulStrings.WAREHOUSEMAN_GUI);
