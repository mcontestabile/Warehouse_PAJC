...
public class WareHouseCostumerForm extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    WareHouseCostumerForm wareHouse = new WareHouseCostumerForm();
     ...
     */
    public WareHouseCostumerForm() throws UnknownHostException, IOException, ClassNotFoundException {
        initialize();
    }
